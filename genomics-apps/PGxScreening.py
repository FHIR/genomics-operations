...
def findSubjectHaplotypes(subject):
     ...
     url='https://fhir-gen-ops.herokuapp.com/subject-operations/genotype-operations/$find-subject-haplotypes?subject='+subject+'&genes=http://www.genenames.org/geneId|HGNC:2615,http://www.genenames.org/geneId|HGNC:2623,http://www.genenames.org/geneId|HGNC:2621,http://www.genenames.org/geneId|HGNC:2625,http://www.genenames.org/geneId|HGNC:2638,http://www.genenames.org/geneId|HGNC:23063,http://www.genenames.org/geneId|HGNC:10959,http://www.genenames.org/geneId|HGNC:12014,http://www.genenames.org/geneId|HGNC:12530'
...
def getMedicationList(subject):
     with open('/app/genomics-operations/genomics-apps/product.csv') as productFile:
...
with col2:
     ...
     if count==0: st.write('### No PGx data')
     else: 
